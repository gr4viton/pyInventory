...
____________________________________________________
jak zjistit zda-li mcu má podporu SDK nebo oboji nebo pouze SDK:
...
[] MCU_REL revision number- nekdy do resolution - resolve do jiry chce to císlo..
najet na soubor a dát history
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/ Eclipse 
...
[] Enable component - ppo rucní editac .pe
...
[]  seznam všech PE podporovaných MCU lze vyvolat
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
// KDS
[] odinstalace obcas nestací
- musí se smazat i obsah složky instalace (zustavají pluginy) 2014_08_18
- C:\ProgramData\Processor Expert\PECache\ - obcas pomože smazat.. (stací poslední
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
// PE Micro OpenSDA
[] není radno nechávat pripojene 2 desky obe s OpenSDA
- je to pomalejsi !
...
Martin formánek - cesta z lomnice..
Jirka - vpravo CCW 1 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
attendence
-> dyž nemocen tak volám olze! ona to zadá!
-> zadávat že nepracoval - to može zmenit.. ale pracoval na nepracoval nezmeni 
...
- zná doktorandy na robotice aj automatizaci - byli s nim v rocniku
kríz, štastný, rozmocil?, španel?
